...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendor/signericafat.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendor/cerebrisans.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendor/simple-line-icons.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendor/elegant.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendor/linear-icon.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/plugins/nice-select.css')}}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/plugins/easyzoom.css')}}">
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/plugins/jquery-ui.css')}}">
                    ...
                    <div class="row flex-row-reverse">
                        <div class="col-lg-6 col-md-6">
                            <div class="payment-img payment-img-right">
                                <a href="#"><img src="{{ asset('public/assets/images/icon-img/payment.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="col-lg-5 col-md-6 col-12 col-sm-12">
                                <div class="tab-content quickview-big-img">
                                    <div id="pro-1" class="tab-pane fade show active">
                                        <img src="{{ asset('public/assets/images/product/product-1.jpg')}}" alt="">
                                    </div>
                                    <div id="pro-2" class="tab-pane fade">
                                        <img src="{{ asset('public/assets/images/product/product-3.jpg')}}" alt="">
                                    </div>
                                    <div id="pro-3" class="tab-pane fade">
                                        <img src="{{ asset('public/assets/images/product/product-6.jpg')}}" alt="">
                                    </div>
                                ...
                                <div class="quickview-wrap mt-15">
                                    <div class="quickview-slide-active nav-style-6">
                                        <a class="active" data-toggle="tab" href="#pro-1"><img src="{{ asset('public/assets/images/product/quickview-s1.jpg')}}" alt=""></a>
                                        <a data-toggle="tab" href="#pro-2"><img src="{{ asset('public/assets/images/product/quickview-s2.jpg')}}" alt=""></a>
                                        <a data-toggle="tab" href="#pro-3"><img src="{{ asset('public/assets/images/product/quickview-s3.jpg')}}" alt=""></a>
                                        <a data-toggle="tab" href="#pro-4"><img src="{{ asset('public/assets/images/product/quickview-s2.jpg')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
...
============================================ -->
    ...
    <script src="{{ asset('public/assets/js/plugins/jquery.instagramfeed.min.js') }}"></script>
    <script src="{{ asset('public/assets/js/plugins/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('public/assets/js/plugins/wow.js') }}"></script>
    <script src="{{ asset('public/assets/js/plugins/jquery-ui-touch-punch.js') }}"></script>
    ...
    <script src="{{ asset('public/assets/js/plugins/sticky-sidebar.js') }}"></script>
    <script src="{{ asset('public/assets/js/plugins/easyzoom.js') }}"></script>
