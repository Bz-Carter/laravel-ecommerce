            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-2">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('public/assets/images/logo/logo.png') }}"
                                    alt="logo"></a>
                        </div>
                    </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="product-details-sticky.html">sticky style</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        <a href="shop.html"><img
                                                                src="{{ asset('public/assets/images/banner/banner-12.png') }}"
                                                                alt=""></a>
                                                    </li>
                                                </ul>
                                            </li>
                        ...
                        <div class="header-action header-action-flex">
                            ...
                            <div class="same-style-2 same-style-2-font-inc">
                                <a href="wishlist.html"><i class="icon-heart"></i><span
                                        class="pro-count purple">03</span></a>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="main-categori-wrap main-categori-wrap-modify">
                            <a class="categori-show" href="#"><i class="lnr lnr-menu"></i> All Department <i
                                    class="icon-arrow-down icon-right"></i></a>
                            <div class="category-menu categori-hide categori-not-visible">
                                <nav>
                                    <ul>
                                        <li class="cr-dropdown"><a href="#">Clothing <span
                                            ...
                                            <div class="category-menu-dropdown ct-menu-res-height-1">
                                                ...
                                                <div class="single-category-menu">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('public/assets/images/menu/menu-categori-1.png') }}"
                                                            alt=""></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="cr-dropdown"><a href="#">Women <span
                                                    class="icon-arrow-right"></span></a>
                                        ...
                                        <li class="cr-dropdown"><a href="#">Men <span
                                                    class="icon-arrow-right"></span></a>
                                            <div class="category-menu-dropdown ct-menu-res-height-1">
                                                <div
                                                    class="single-category-menu ct-menu-mrg-bottom category-menu-border">
                                        ...
                                        <li class="cr-dropdown"><a href="#">Baby Girl <span
                                                    class="icon-arrow-right"></span></a>
                                            <div class="category-menu-dropdown ct-menu-res-height-2">
                                                <div class="single-category-menu">
                                                    <h4>Men Clothing</h4>
            ...
            <div class="row align-items-center">
                <div class="col-5">
                    <div class="mobile-logo">
                        <a href="index.html">
                            <img alt="" src="{{ asset('public/assets/images/logo/logo.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-7">
        ...
        <div class="cart-content">
            ...
            <ul>
                <li class="single-product-cart">
                    <div class="cart-img">
                        <a href="#"><img src="{{ asset('public/assets/images/cart/cart-1.jpg') }}" alt=""></a>
                    </div>
                ...
                <li class="single-product-cart">
                    <div class="cart-img">
                        <a href="#"><img src="{{ asset('public/assets/images/cart/cart-2.jpg') }}" alt=""></a>
                    </div>
                    <div class="cart-title">
