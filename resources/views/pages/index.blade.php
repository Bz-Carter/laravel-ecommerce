...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="hero-slider-content-1 slider-animated-1 hero-slider-content-1-padding1">
                                            ...
                                            <p class="animated width-inc">Discover our collection with leather simple
                                                backpacks. Less is more never out trend.</p>
                                            <div class="btn-style-1">
                                                <a class="animated btn-1-padding-1 btn-1-bg-purple"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="hm6-hero-slider-img slider-animated-1">
                                            <img class="animated"
                                                src="{{ asset('public/assets/images/slider/hm-1-slider-1.png') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="banner-wrap mb-30">
                                <div class="banner-img banner-img-zoom">
                                    <a href="product-details.html"><img
                                            src="{{ asset('public/assets/images/banner/banner-14.jpg') }}" alt=""></a>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="banner-wrap mb-30">
                                <div class="banner-img banner-img-zoom">
                                    <a href="product-details.html"><img
                                            src="{{ asset('public/assets/images/banner/banner-15.jpg') }}" alt=""></a>
                                </div>
            ...
            <div class="product-slider-active-3 nav-style-3">
                    ...
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{ asset('public/assets/images/product/product-41.jpg') }}" alt="">
                            </a>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{ asset('public/assets/images/product/product-42.jpg') }}" alt="">
                            </a>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{ asset('public/assets/images/product/product-43.jpg') }}" alt="">
                            </a>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{ asset('public/assets/images/product/product-44.jpg') }}" alt="">
                            </a>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{ asset('public/assets/images/product/product-45.jpg') }}" alt="">
                            </a>
            ...
            <div class="product-categories-slider-1 nav-style-3">
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-50.png') }}" alt="">
                            </a>
                        </div>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-51.png') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-categories-2 text-center">
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-52.png') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-categories-2 text-center">
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-53.png') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-categories-2 text-center">
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-54.png') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-categories-2 text-center">
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-border mb-20">
                            <a href="shop.html">
                                <img src="{{ asset('public/assets/images/product/product-55.png') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-categories-2 text-center">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="banner-wrap mb-30">
                        <div class="banner-img banner-img-zoom">
                            <a href="product-details.html"><img
                                    src="{{ asset('public/assets/images/banner/banner-10.jpg') }}" alt=""></a>
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="banner-wrap mb-30">
                        <div class="banner-img banner-img-zoom">
                            <a href="product-details.html"><img
                                    src="{{ asset('public/assets/images/banner/banner-11.jpg') }}" alt=""></a>
                        </div>
                        <div class="banner-content-11 banner-content-11-modify">
                            ...
                            <div class="product-slider-active-5">
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-46.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        ...
                                        <div
                                            class="product-content-wrap-2 product-content-wrap-2-modify product-content-position text-center">
                                            <h3><a href="product-details.html">Mini Protector</a></h3>
                                            <div class="product-price-2">
                                                <span>$38.50</span>
                                            </div>
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-47.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-48.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-49.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-16.jpg') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 banner-mt-none-xs mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-17.jpg') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="product-slider-active-5">
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-81.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-82.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-83.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-84.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-23.jpg') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 banner-mt-none-xs mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-24.jpg') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="product-slider-active-5">
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-85.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-86.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-87.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-plr-1">
                                    <div class="single-product-wrap">
                                        <div class="product-img product-img-zoom mb-15">
                                            <a href="product-details.html">
                                                <img src="{{ asset('public/assets/images/product/product-88.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-wrap-2 text-center">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-25.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="banner-content-19">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="banner-wrap banner-border-1 banner-mt-none-xs mt-40 mb-30">
                                    <div class="banner-img banner-img-zoom">
                                        <a href="product-details.html"><img
                                                src="{{ asset('public/assets/images/banner/banner-26.jpg') }}" alt=""></a>
                                    </div>
    ...
    <div class="brand-logo-area pb-80">
        <div class="container">
            <div class="brand-logo-wrap-2">
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-6.png') }}" alt="brand-logo">
                </div>
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-7.png') }}" alt="brand-logo">
                </div>
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-8.png') }}" alt="brand-logo">
                </div>
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-9.png') }}" alt="brand-logo">
                </div>
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-10.png') }}" alt="brand-logo">
                </div>
                <div class="single-brand-logo-2 mb-30">
                    <img src="{{ asset('public/assets/images/brand-logo/brand-logo-11.png') }}" alt="brand-logo">
                </div>
            </div>
        </div>
    </div>
